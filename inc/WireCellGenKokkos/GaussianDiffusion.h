...
namespace WireCell {
    namespace GenKokkos {
        ...
        class GaussianDiffusion {
...
#ifdef HAVE_CUDA_INC
            void set_sampling_CUDA(double* pvec_D, double* tvec_D, float* patch_D, float* rand_D,
                                   curandGenerator_t* gen, const Binning& tbin, const Binning& pbin,
           ...
           private:
#ifdef HAVE_CUDA_INC
            void sampling_CUDA(double* pvec, const size_t npss, double* tvec, const size_t ntss, float* output,
                               const double sign, const double charge, double* pvec_D, double* tvec_D, float* patch_D,
                               bool fluc, float* rand_D, curandGenerator_t* gen);
#endif
        };
    }  // namespace GenKokkos
}  // namespace WireCell
